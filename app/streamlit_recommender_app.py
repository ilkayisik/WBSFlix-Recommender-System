...
if user_based_rec:
    ...
    if submit_button_user:
        user_movie_recs = weighted_user_rec(user_id, nr_rec)
...
# user_id = st.number_input("please enter your user id", step=1, min_value=1)
# n = st.number_input("please enter the number of recommendations you want to receive",
#                      step=1)
# top_recommendations = weighted_user_rec(user_id, n)

# st.table(top_recommendations)
